...
machine, api/telegram.py feeds it one update per request on Vercel.
...
text and the bot needs no state at all.
"""
...
def build_application():
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND , tracker_controller.tracker_controller.unknown))
