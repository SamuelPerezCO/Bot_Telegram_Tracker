...
Open `https://your-project.vercel.app/api/telegram` in a browser to confirm the deployment is alive; it answers with a short text.
...
```
api/
|-- telegram.py                  # Vercel entry point: one HTTP request = one update
scripts/
